            ...
            {applications.map((app) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`hidden sm:inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-lg border flex-shrink-0
                  ...
                  <select
                    ...
                    className="flex-shrink-0 text-xs font-semibold text-slate-700 bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 outline-none cursor-pointer transition-all focus:border-blue-500 focus:ring-2 focus:ring-blue-100 hover:border-slate-300"
                  >
                    <option value="Applied">Applied</option>
                    <option value="Reviewed">Reviewed</option>
                    <option value="Shortlisted">Shortlisted</option>
